...
- Two-line Dockerfile (nginx + `site/`) and a compose file that builds and runs it; Caddy on bulbul
  serves it as `norsk.home`, replacing the archived scenario viewer. React, Vite and npm are gone.
